...
\thesistitle{ Defining a structure for decision logging and knowledge management in for DevOps teams}             % Thesis title,              command: \ttitle
\thesistype{Bachelor Thesis}             % Type of thesis (e.g. Master Thesis) \ttype
\thesisdate{\today}                     % Date of submission                  \tdate
\keywords{devops, software development, decision logging, knowledge graph}
